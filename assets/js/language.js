var contentx = {
  en: {
    ...
    trusted_partners_txt:
      'Your business will have a reliable partner to transfer raw materials to the factory.',
    phone: 'Phone',
    address: 'Address',
    ready_to:
      'We are always ready to address your needs and concerns regarding our services, ' +
    ...
    items_why:
      ...
      '                    </li>',
    work_near:
      '<i class="bi bi-check2-all"></i>We work closely with our customers to ensure the success of their logistics and transport operations.',
    we_guide:
      '<i class="bi bi-check2-all"></i>We follow the development of our clients over time.',
    all_size:
      '<i class="bi bi-check2-all"></i> We serve clients of different sizes and sectors.',
    efficient_sol_txt:
      'This partner will offer efficient and reliable solutions for material transfers.',
    efficient_sol: 'Efficient and reliable solutions',
    concentration_tt: 'Focus on the most important',
    concentration_txt:
      'By having Transnur, Lda as a partner for these transfers, your business can concentrate on ' +
    ...
    why_txt_2:
      '<li ><i class="bi bi-check2-all"></i> Choosing Transnur, Lda services means choosing an experienced company committed to customer satisfaction.\n' +
      '                    </li>\n' +
      '                    <li>\n' +
      ...
      '                    </li>',
    contacts:
      'Rua das rosas, Sommerschield II,<br />\n' +
    ...
    points_txt_1:
      'It is responsible for protecting the product during transport and ensuring that it arrives at its destination in perfect condition.\n' +
      '                    <br />\n' +
      '                    <br />\n' +
  ...
  pt: {
    ...
    trusted_partners:
      'Parceiro confiável para transferências de\n' +
      '                        matéria-prima',
    ready_to:
      'Nós estamos sempre prontos para atender às suas necessidades e\n' +
      ...
      '            ao nosso negócio. ',
    trusted_partners_txt:
      '                    Seu negócio terá um parceiro confiável para realizar as\n' +
    ...
    items_why:
      ...
      '                    </li>',
    work_near:
      '<i class="bi bi-check2-all"></i>Trabalhamos de perto com\n' +
      '                      nossos clientes para garantir o sucesso de suas operações\n' +
      'de logística e transporte.',
    we_guide:
      '<i class="bi bi-check2-all"></i> Acompanhamos o\n' +
      'desenvolvimento dos nossos clientes ao longo do tempo.',
    all_size:
      '<i class="bi bi-check2-all"></i> Atendemos a clientes de\n' +
      'diferentes tamanhos e setores.',
    efficient_sol_txt:
      'Esse parceiro oferecerá soluções eficientes e confiáveis\n' +
    ...
    concentration_txt:
      '                    Ao ter a Transnur, Lda com um parceiro para essas transferências,\n' +
    ...
    our_solution_txt:
      ...
      '            exclusiva.',
    about_txt1:
      '          É uma empresa voltada a oferecer soluções de Transportes de cargas\n' +
    ...
    about_txt2:
      '              Somos uma empresa jovem especialistas em Transportes de cargas,\n' +
      '              capacitação e dedicação aos segmentos, com segurança, qualidade e\n' +
      '              a garantia de excelência dos serviços prestados.',
    about_txt3:
      '              Possuímos um tipo de veículo que atenderá a sua operação de forma\n' +
    ...
    our_mission_txt:
      '              Estabelecer uma relação de parceria com nossos clientes,\n' +
    ...
    points_txt_3:
      '                  Compreendemos a importância de garantir que suas mercadorias\n' +
